...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-info"><strong> Edit: {{ $user->name }}</strong></div>
                ...
                <div class="card-body">
                    <form method="POST" action="/users/edit/{{ $user->id }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="dept" type="text" class="form-control @error('dept') is-invalid @enderror" name="dept" value="{{ $user->dept }}" required autocomplete="dept" autofocus>
